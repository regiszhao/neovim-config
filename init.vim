...
" Necessary for a bunch of plug-ins to work lol idk why
set termguicolors
...
" Basic ---------------------------------
Plug 'junegunn/fzf', { 'do': { -> fzf#install() } } " for finding files
...
require('bufferline').setup {
  options = {
    ...
    --   end
    -- end,
    offsets = {{filetype = "NvimTree", text = "File Explorer", highlight = "Directory", text_align = "left"}}, -- text_align = "left" | "center" | "right"
